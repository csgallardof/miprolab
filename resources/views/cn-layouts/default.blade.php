...
<body class="{{ $bodyClass }}">
	@include('cn-includes.component.page-loader')
	
	<div id="page-container" class="page-container fade page-sidebar-fixed page-header-fixed {{ $pageContainerClass }}">
		
		@include('cn-includes.header')
		
		@includeWhen($topMenu, 'cn-includes.top-menu')
		
		@includeWhen(!$sidebarHide, 'cn-includes.sidebar')
		
		@includeWhen($sidebarTwo, 'cn-includes.sidebar-right')
		
		<div id="content" class="content {{ $contentClass }}">
			@yield('contenido')
		</div>
		
		@includeWhen($footer, 'cn-includes.footer')
		
		@include('cn-includes.component.theme-panel')
		
		@include('cn-includes.component.scroll-top-btn')
		
	</div>
	
	@include('cn-includes.page-js')
</body>
</html>
