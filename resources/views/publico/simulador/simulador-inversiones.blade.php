      ...
      <div id="content" class="content">
        ...
        <div class="row">
            ...
            <div class="col-md-12">
              ...
              <form  method="POST" action="{{ route('consultar.simulador') }}"  enctype="multipart/form-data">
                    ...
                    {{ csrf_field() }}
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-4">
                            <label>¿Qué tipo de empresa pertence?</label>
                              <select class="form-control" name="tipo_empresa" required="Seleccione una opción">
                      ...
                      <div class="form-group">
                        <div class="row">
                          ...
                          <div class="col-md-4">
                           ...
                           <select class="form-control" id="select-required" name="sector" required="Seleccione una opción">
                      ...
                      <div class="form-group">
                        <div class="row">
                          <div class="col-md-2"></div>
                          <div class="col-md-4">
                            <label for="lugar">¿Lugar donde se va a establecer?</label>
                            <select id="select-provincia" onchange="getSelectValue();" name="select-provincia" class="form-control selectpicker" data-size="10" data-live-search="true" required="Seleccione una opción" data-style="btn-primary">
                      ...
                      <div class="form-group">
                        <div class="row">
                          ...
                          <div class="col-md-8">
                            <label for="monto">¿Cuál es su monto estimado para  inversión ?</label><br>
                            <label class="radio p-l-30 p-t-20">
                              <input type="radio" name="monto_radio" value="1" required="Seleccione una opción" />
                                Hasta USD 1 milLón
                            </label>
                            <label class="radio p-l-30 p-t-20">
                                <input type="radio" name="monto_radio" value="1-10" required="Seleccione una opción" />
                                De  USD 1  millon a USD 10  millon
                            </label>
                            <label class="radio p-l-30 p-t-20">
                                <input type="radio" name="monto_radio" value="10+" required="Seleccione una opción" />
                      ...
                      <div class="form-group">
                        <div class="row">
                          ...
                          <div class="col-md-8">
                            <label for="mercado">¿Su mercado objetivo es primordialmente ?</label><br>
                            <label class="radio p-l-30 p-t-20">
                              <input type="radio" name="mercado_radio" value="m_local" required="Seleccione una opción" />
                                Mercado Local
                            </label>
                            <label class="radio p-l-30 p-t-20">
                                <input type="radio" name="mercado_radio" value="m_exportaciones" required="Seleccione una opción" />
                                Exportaciones
                            </label>
                          </div>
                        </div>
                      ...
                      <div class="form-group">
                        <div class="row">
                          ...
                          <div class="col-md-8">
                            ...
                            <label class="radio p-l-30 p-t-20">
                              <input type="radio" name="reduccion_radios" value="r_si" required="Seleccione una opción" />
                                SI
                            </label>
                            <label class="radio p-l-30 p-t-20">
                                <input type="radio" name="reduccion_radios" value="r_no" required="Seleccione una opción" />
                                NO
                            </label>
                          </div>
                        </div>
                      ...
                      <div class="form-group">
                        <div class="row">
                          ...
                          <div class="col-md-8">
                            ...
                            <label class="radio p-l-30 p-t-20">
                              <input type="radio" name="app_radio" value="app_si" required="Seleccione una opción" />
                                SI
                            </label>
                            <label class="radio p-l-30 p-t-20">
                                <input type="radio" name="app_radio" value="app_no" required="Seleccione una opción" />
                                NO definida
                            </label>
                          </div>
                        </div>
