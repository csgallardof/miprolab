					...
					<div class="panel panel-inverse" data-sortable-id="index-5">
						...
						<div class="panel-body">
								...
								<div class="media-body">
									...
									<form  method="POST" action="/institucion/editar-actividades-solucion/{{$actividades->id}}" enctype="multipart/form-data">
										{{ csrf_field() }}
										<input type="hidden" name="tipo_fuente_id" value="1">
										<input type="hidden" name="solucion_id" value="{{ $soluciones->id }}">
									 	...
									 	<div class="form-group">
									 		<div class="row">
									 			...
									 			<textarea class="ckeditor" id="editor1" name="comentario" rows="6">
