...
<div id="header" class="header {{ $headerClass }}">
	...
	<ul class="navbar-nav navbar-right">
		...
		<li class="dropdown">
			...
			<ul class="dropdown-menu media-list dropdown-menu-right">
				...
				<li class="media">
					<a href="javascript:;">
						<div class="media-left">
							<img src="/cn-assets/img/user/user-1.jpg" class="media-object" alt="" />
				...
				<li class="media">
					<a href="javascript:;">
						<div class="media-left">
							<img src="/cn-assets/img/user/user-2.jpg" class="media-object" alt="" />
							<i class="fab fa-facebook-messenger text-primary media-object-icon"></i>
						</div>
						<div class="media-body">
		...
		<li class="dropdown navbar-user">
			<a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown">
				<img src="/cn-assets/img/user/user-13.jpg" alt="" /> 
